    ...
    <basic-container>
        ...
        <avue-crud  ref='crud' :data='data' :option='option' :table-loading="loading" :page="page"   @selection-change="selectionChange"  @size-change="sizeChange"  @current-change="currentChange" :cell-style="cellStyle" :row-style="rowStyle">
            <template slot-scope="scope" slot="menu">
                  ...
                  <el-button type="text" size="small" icon="el-icon-view" @click.stop="accredits(scope.row,scope.index)">授权查看</el-button>
                  <el-button type="text" size="small" icon="el-icon-picture-outline" @click.stop="lookImg(scope.row)">流程监控图</el-button>
                  <el-button type="text" size="small" icon="el-icon-delete" @click.stop="cancell(scope.row)" v-show="scope.row.status==1" style="color:red">作废</el-button>
            </template>
...
import { myToDoList,userBySearch } from "@/api/work/todo";
import { myInstanceList,adminTask,impowerProcess } from "@/api/work/work";
