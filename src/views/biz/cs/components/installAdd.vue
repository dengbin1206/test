<template>
    <div style="width:100%;padding:0 20px;">
        <template>
            <el-button type="primary" size="small" @click="pgxxOpen" v-if="btnList.pg_btn">派工</el-button>
            <el-button type="primary" size="small" @click='bnfcOpen' v-if="btnList.bwfc_btn">保外返厂</el-button>
            <el-button type="primary" size="small" @click="hfdjOpen"  v-if="btnList.hfdj_btn">回访登记</el-button>
        </template>
        <el-form :model="addList" :label-position='labelPosition' :rules="rules" ref="ruleForm" label-width="150px"   class="sx_formItem">
            ...
            <el-row>
                ...
                <el-table
                    :data="addList.installProductInfoVOS"
                    ...
                    <el-table-column prop="contractNum" label="纸质合同号" width="150"></el-table-column>
                    <el-table-column  prop="startNum" label="出厂编号" width="150"></el-table-column>
                    <el-table-column  prop="productType" label="产品大类" width="150">
                    ...
                    <el-table-column  prop="materialCode" label="物料号" width="150"></el-table-column>
                    ...
                    <el-table-column  prop="finishNum" label="安装完成数量" width="150"></el-table-column>
                </el-table>
            </el-row>
...
import {save,detail} from '@/api/biz/cs/install'
...
export default {
  ...
  data() {
    return {
      ...
      dataList: [],
      dataSrcId: "CS_AZSQ",
      affixType: "CS_AZSQ#AFFIX_UPLOAD",
      mainId: "",
      rules: {
  ...
  methods: {
    ...
    contractIdChange(){
        ...
        this.contractIds.forEach(item=>{
            if(item.paperContractNo==this.addList.paperContractNo){
                ...
                this.$set(this.addList,'installProductInfoVOS',item.productContractInfoVOS)
                this.addList.installProductInfoVOS.forEach((item,index)=>{
    ...
    getDefaultVal(){
        addDefaultVaule('CS_AZSQ').then(res=>{
    ...
    pgxxOpen(){
      this.pgxxDia=true
      setTimeout(() => {
        this.$refs.pgxx.confirmProcess(this.addList.id,3)
      }, 1000)
    },
    bnfcOpen(){
      this.turnoff()
