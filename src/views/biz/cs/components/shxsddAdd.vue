<template>
    <div>
            ...
            <el-form :model="addList" :label-position='labelPosition' :rules="rules" ref="ruleForm" label-width="150px"   class="sx_formItem">
                  ...
                  <h4>销售订单基本信息</h4>
                    <el-col :span="ispc">
                        <el-form-item label="订单类型:" prop="orderType">
                            <el-select v-model="addList.orderType" size="small" placeholder="请选择订单类型" disabled>
                                    <el-option
                        ...
                        <el-form-item label="销售组织:" prop="saleGroup">
                            <el-select v-model="addList.saleGroup" size="small" placeholder="请选择销售组织">
                                    <el-option
                        ...
                        <el-form-item label="排单类型:" prop="billingType">
                            <el-radio-group v-model="addList.billingType" size="small">
                        ...
                        <el-form-item label="销售订单号:" prop="salesOrderNum">
                            <el-input size="small" v-model="addList.salesOrderNum" disabled></el-input>
                        </el-form-item>
                        <el-form-item label="合同类型:" prop="contractType">
                            <el-select size="small" v-model="addList.contractType" style="width:100%">
                    ...
                    <el-col :span="ispc">
                        <el-form-item label="售后关联单据:" prop="relateFormName">
                        ...
                        <el-form-item label="请求交货日期:" prop="requestDeliveryDate">
                            <el-date-picker
                        ...
                        <el-form-item label="客户级别:" prop="clientClazz">
                            <el-select size="small" v-model="addList.clientClazz"  placeholder="请选择行业"  style="width:100%" disabled>
                                <el-option
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="订单要求:" prop="orderRequire">
                            <el-input size="small" v-model="addList.orderRequire" placeholder="请输入订单要求" type="textarea" rows="3"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="变更要求:" prop="alterRequire">
                            <el-input size="small" v-model="addList.alterRequire" placeholder="请输入订单要求" type="textarea" rows="3"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                  <h4>单据基本信息</h4>
                    ...
                    <el-col :span="ispc">
                        <el-form-item label="变更人:" prop="updateUserName">
                            <el-input size="small" v-model="addList.updateUserName" disabled></el-input>
                        </el-form-item>
                        <el-form-item label="变更结束时间:" prop="updateTime">
                            <el-input size="small" v-model="addList.updateTime" disabled></el-input>
                        </el-form-item>
                  ...
                  <h4>财务信息(<span style="color:red">单独权限</span>)</h4>
                    <el-col :span="ispc">
                        <el-form-item label="净值(万元):" prop="netWorth">
                            <el-input size="small" v-model="addList.netWorth" placeholder="自动生成" disabled></el-input>
                        </el-form-item>
                        <el-form-item label="税额(万元):" prop="taxAmount">
                            <el-input size="small" v-model="addList.taxAmount" placeholder="自动生成" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="ispc">
                        <el-form-item label="含税金额(万元):" prop="includeTaxAmount">
                            <span style="width:70%;float:left">
                                <el-input size="small" v-model="addList.includeTaxAmount" placeholder="自动生成"  disabled></el-input>
                            </span>
                ...
                <el-row :gutter="20">
                  <h4>产品信息</h4>
                    <el-col :span="24">
                        ...
                        <el-table
                            class="sx_htps_cpxx"
                            :data="addList.afterSaleProductInfoVOS"
...
import {detail,submit,getData} from '@/api/biz/cs/shxsdd'
...
export default {
  ...
  methods: {
    ...
    getDefaultVal() {
      addDefaultVaule("CS_SHXS").then(res => {
        ...
        if (valid) {
          ...
          submit(this.addList).then(res => {
            if (res.data.code == 200) {
              ...
              let flowKey = "CS_SHXS_DART";
              this.getModel("CS_SHXS", flowKey);
            } else {
              this.$message({
                message: res.data.msg,
                type: "error"
    ...
    priceChange() {
      let num = 0,
        wor = 0;
      for (var i = 0; i < this.addList.afterSaleProductInfoVOS.length; i++) {
        this.addList.afterSaleProductInfoVOS[i].totalTexNum = (
          Number(this.addList.afterSaleProductInfoVOS[i].includeTexPrice) *
          Number(this.addList.afterSaleProductInfoVOS[i].productNum)
        ).toFixed(2);
        this.addList.afterSaleProductInfoVOS[i].netWorth =
          this.addList.afterSaleProductInfoVOS[i].totalTexNum /
          (1 + Number(this.addList.afterSaleProductInfoVOS[i].saleRowTex));
        num += Number(this.addList.afterSaleProductInfoVOS[i].totalTexNum);
        wor += Number(this.addList.afterSaleProductInfoVOS[i].netWorth);
      }
    ...
    requestDate() {
      this.addList.afterSaleProductInfoVOS.forEach(item => {
    ...
    saleAdd() {
      this.addList.afterSaleProductInfoVOS.push({
      ...
      this.addList.afterSaleProductInfoVOS.forEach((item,index)=>{
        item.rowNum=(index+1)*10
      })
    },
    saleDel(row, index) {
      this.addList.afterSaleProductInfoVOS.splice(index, 1);
      if (row.id) {
...
<style scoped>
@import "../../crm/components/xmbdStyle/htps.scss";
</style>
