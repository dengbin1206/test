        ...
        <avue-crud :option="option"
            ...
            <template slot-scope="scope" slot="menu">
              ...
              <el-button icon="el-icon-edit" size="small" type="text"  @click="edit(scope.row)" v-if="scope.row.flowStatus==='2'||scope.row.flowStatus==='0'||scope.row.flowStatus==='5'">编辑</el-button>
                <el-button icon="el-icon-s-flag" size="small" type="text"  @click="looking(scope.row)" v-if="scope.row.flowStatus!=='0'">查看审批</el-button>
...
import addDialog from "./components/shxsddAdd";
import { list,deletedByIds } from "@/api/biz/cs/shxsdd"; 
