...
import addDialog from "./components/maintenanceAdd";
import { list,deletedById } from "@/api/biz/cs/maintenance";
    ...
    search(val) {
      ...
      let obj = {
        ...
        extQueryList: [
          ...
          {
            field: "flowCompletedTime",
            expressionList: [
              {
                operator: "EQ",
                lowerValue: val.flowCompletedTime,
                upperValue: ""
              }
            ]
          }
