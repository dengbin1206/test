<template>
  <basic-container  style="width:100%;height:100%;;overflow-y:auto">
               <van-nav-bar
    ...
    />
        <el-form :model="basicForm" label-position="left" style="height:100%" :rules="giftRules" ref="ruleForm" label-width="130px" size="small" :disabled="editFlag !=undefined ? !editFlag : false">
            <h4>基础信息</h4>
          <el-row > 
              ...
              <el-form-item label="费用承担:" prop="costBearing">
                <el-select v-model="basicForm.costBearing"  placeholder="请选择费用承担方式">
                  <el-option
              ...
              <el-form-item label="承担方式:" v-if="basicForm.costBearing == '0'">
                <el-select v-model="basicForm.bearMode"  placeholder="请选择承担方式">
                  <el-option
          ...
          >
            ...
            <el-table-column prop="giftNum" label="数量" align="center" width="140">
              ...
              <template slot-scope="scope">
                ...
                <el-input size="small" clearable v-model="scope.row.giftNum" @change="handleEdit(scope.$index, scope.row)" placeholder="请输入数量"></el-input>
                  </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="giftCompany" label="单价" align="center" width="140">
              ...
              <template slot-scope="scope">
                ...
                <el-input size="small" clearable v-model="scope.row.giftCompany" @change="handleEdit(scope.$index, scope.row)" placeholder="请输入单价"></el-input>
                  </el-form-item>
              </template>
            </el-table-column>
      ...
      <div class="gift_m_btn" style="margin-top:10px;text-align:right;">
        <!-- <el-button
          v-if="editFlag==undefined"
          type="primary"
          size="small"
...
export default {
  ...
  props:{
    ...
    methods:{
      // isRequiredProduct(){
      //   if(this.basicForm.giftCost > 1200) {
      //     return  true;
      //   }else{
      //     return false;
      //   } 
