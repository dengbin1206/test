...
<script>
import addDialog from "./components/bfhAdd";
import { bfList } from "@/api/biz/crm/fhsq"; 
    ...
    search(val) {
      ...
      let obj = {
        ...
        extQueryList: [
          ...
          {
            field: "repairDeliveryNum",
            expressionList: [
              {
                operator: "EQ",
                lowerValue: val.repairDeliveryNum,
                upperValue: ""
              }
            ]
          }
        ...
        rows: [
          [
            ...
            },
            {
              type: "input",
              queryType: "1",
              prop: "repairDeliveryNum",
              label: "补发货单号:",
              placeholder: "请输入补发货单号"
            }
          ]
        ]
      },
