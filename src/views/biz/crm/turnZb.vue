<template>
    ...
    <template slot-scope="scope" slot="menuLeft">
      ...
      <template slot-scope="scope" slot="menu">
        ...
        >查看审批</el-button>
        <el-button icon="el-icon-edit" size="small" type="text" :disabled="scope.row.flowStatus != '0'"  @click="zbDetail(scope.row)">编 辑</el-button>
      </template>
    </avue-crud>
    <el-dialog 
       v-dialog
     ...
     modal-append-to-body
      ...
      <ZbAdd ref="ZbAdd" @api="api" :dialogVisible="dialogVisible"  @closeDialog="closeDialog"/>
      </div>
    </el-dialog>
...
import ZbAdd from "./components/turnZbAdd";
     ...
     data(){
      ...
      option: {
        ...
        column: [
          ...
          {
            label: "转服务费",
            prop: "bidServiceAmount"
          },
           {
            label: "剩余保证金",
            prop: "surplusBidBondAmount",
            width:100
          },
          {
            label: "负责员工",
