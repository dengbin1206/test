...
<script>
import { list,submit,remove } from "@/api/biz/guarantee/evaluation";
export default {
  methods: {
   rowStyle(){
      return 'height: 35px'
    ...
    return {
          ...
          [
            {
              ...
              label: "报告名称:",
              placeholder: "请输入关键字",
              url:'api/blade-crm/standard/standardByProject?search='
            }
          ]
        ]
      },
      option: {
        ...
        column: [
            ...
            dicUrl: 'api/blade-crm/report/reportTypeBySearch?search={{key}}',
            dicMethod: 'get',
            filterable: true,
            remote: true,
            clearable: true,
