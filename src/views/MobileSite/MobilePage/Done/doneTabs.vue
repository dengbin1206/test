      ...
      >
        ...
        >
          <div class="left">
            <div>
              {{ `事务编号:${item.instId}` }}
              <van-tag v-if="item.status === 1" type="warning" color="#fdb933">处理中</van-tag>
...
<script>
import { myDoneList } from "@/api/mobileApi/flow";
