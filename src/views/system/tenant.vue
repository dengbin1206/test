...
<script>
  import {getList, getDetail, remove, update, add, setting , getzzData} from "@/api/system/tenant";
        ...
        option: {
          ...
          column: [
            ...
            },
            {
              ...
              span:24,
              type:'select',
              dicUrl: "/api/blade-system/dict/dictionary?code=tenant_org_type",
              props:{
                label:'dictValue',
                value:'dictKey'
              }
...
/* .sx_tenant_table .el-table__body{
  width: 100% !important;
