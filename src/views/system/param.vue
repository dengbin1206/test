              ...
              <el-row>
                <el-col :span="9">
                  <el-form-item label="参数编号:">
                    <el-input v-model="parent_form.paramCode" placeholder="请输入参数编号" clearable size="small" maxlength="9" @keyup.enter.native="handleQuery"/>
                  </el-form-item>
                </el-col>
                <el-col :span="9">
                  <el-form-item label="参数名:">
                    <el-input v-model="parent_form.paramName" placeholder="请输入参数名" clearable size="small" maxlength="10" @keyup.enter.native="handleQuery"/>
                  </el-form-item>
                </el-col>
                <el-col :span='6'>
                  <el-button-group>
              ...
              <el-row>
                <el-col :span="9">
                  <el-form-item label="参数键:">
                    <el-input v-model="child_form.paramKey" placeholder="请输入参数键" clearable size="small" maxlength="10" @keyup.enter.native="handleQuery"/>
                  </el-form-item>
                </el-col>
                <el-col :span="9">
                  <el-form-item label="参数值:">
                    <el-input v-model="child_form.paramValue" placeholder="请输入参数值" clearable size="small" maxlength="10" @keyup.enter.native="handleQuery"/>
                  </el-form-item>
                </el-col>
                <el-col :span='6'>
                  <el-button-group>
...
<script>
  import {getParentList,getChildList,add,remove,getDictTree,update,getDict} from '@/api/system/param'
  import {optionParent, optionChild} from "@/const/system/parambiz";
  ...
  export default {
    ...
    methods: {
      ...
      handleRowClick(row) {
        ...
        this.dictValue = row.paramName;
        this.$refs.crudChild.value.paramCode = row.paramCode;
        this.$refs.crudChild.value.parentId = row.id;
        this.$refs.crudChild.option.column.filter(item => {
          if (item.prop === "paramCode") {
            item.value = row.paramCode;
          }
          if (item.prop === "parentId") {
            item.value = row.id;
          }
      ...
      onLoadChild(page, params = {parentId:this.parentId}) {
        ...
        getChildList(
          ...
          this.dataChild = res.data.data.records;
          this.pageChild.total = res.data.data.total;
