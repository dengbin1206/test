  ...
  <div class="todoWrapper">
    <div class="header">
      ...
      >
        ...
        <template #action>
          <span class="text" style="color: #0079fe">不合格品处理</span>
        </template>
      </van-search>
    </div>
    <div class="main">
      ...
      >
        ...
        >
          ...
          >
            <div class="left">
              <div class="title">
                {{ `处理单号:${unqualifiedCode(item.unqualifiedCode)}` }}
              </div>
              <div class="subtitle">
                {{ `申请员工:${item.createUserName}` }}
              </div>
            </div>
            <div class="right">
              <div class="top">
...
<script>
import { getList } from "@/api/quality/unquality";
...
export default {
  ...
  methods: {
    ...mapMutations("quality", ["SET_UNQUALITYROUTE"]),
    async onLoad() {
    ...
    addTest() {
      ...
      this.$router.push("/quality/unqualified");
    },
  },
};
</script>
