  ...
  <div>
    ...
    <div class="el-form-item el-form-item--small el-form--label-top">
      <label class="el-form-item__label" style="padding: 0">
        <el-link :underline="false" target="_blank">参数设置</el-link>
      </label>
      <div class="el-form-item__content">
        返回的数据结构层次
        <el-input
          v-model="data.props.res"
          size="small"
          placeholder="返回的数据结构层次"
        ></el-input>
        返回结构体图片地址字段
        <el-input
          v-model="data.props.url"
          size="small"
    ...
    <template v-if="data.oss == 'ali'">
      <div class="el-form-item el-form-item--small el-form--label-top">
        ...
        <div class="el-form-item__content">
          ...
          accessKeySecret：
          <el-input
            v-model="data.ali.accessKeySecret"
            size="small"
            clearable
