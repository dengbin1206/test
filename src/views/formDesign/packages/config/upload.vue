<template>
  <div>
    ...
    <el-form-item label="接受文件类型" v-if="!data.oss">
      <el-input
        v-model="data.accept"
        clearable
    ...
    <el-form-item label="文件列表类型" v-if="!data.drag">
    ...
    <div class="el-form-item el-form-item--small el-form--label-top">
      ...
      <div class="el-form-item__content">
        请求头
        <avue-dynamic
          v-model="data.headersConfig"
          :children="option"
        ></avue-dynamic>
        请求体
        <avue-dynamic
          v-model="data.dataConfig"
          :children="option"
        ></avue-dynamic>
      </div>
    </div>
    <div class="el-form-item el-form-item--small el-form--label-top">
      <div class="el-form-item__content">
        上传成功返回结构体的图片地址
        <el-input
          v-model="data.propsHttp.url"
          size="small"
          placeholder="上传成功返回结构体的图片地址"
        ></el-input>
        上传成功返回结构体的图片的姓名
        <el-input
          v-model="data.propsHttp.name"
          size="small"
          placeholder="上传成功返回结构体的图片的姓名"
        ></el-input>
        返回结构体的层次
        <el-input
          v-model="data.propsHttp.res"
          size="small"
          placeholder="返回结构体的层次"
        ></el-input>
        文件名称
        <el-input
          v-model="data.propsHttp.fileName"
          size="small"
    ...
    <div class="el-form-item el-form-item--small el-form--label-top">
      ...
      <div class="el-form-item__content">
        水印文字
        <el-input
          v-model="data.canvasOption.text"
          size="small"
          clearable
          placeholder="水印文字"
        ></el-input>
        字体类型
        <el-input
          v-model="data.canvasOption.fontFamily"
          size="small"
          clearable
          placeholder="字体类型"
        ></el-input>
        字体颜色
        <avue-input-color
          v-model="data.canvasOption.color"
          size="small"
          placeholder="字体颜色"
        ></avue-input-color>
        字体大小
