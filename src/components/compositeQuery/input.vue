    ...
    >
      ...
      >
        ...
        <el-table-column prop="lowerValue" label="值小" align="center">
          <template slot-scope="scope">
            <el-input size="small" class="ipt" v-model="scope.row.lowerValue" :placeholder="option.placeholder"></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="upperValue" label="值大" align="center">
          <template slot-scope="scope">
            <el-input size="small" class="ipt" v-model="scope.row.upperValue" :placeholder="option.placeholder"></el-input>
          </template>
        </el-table-column>
