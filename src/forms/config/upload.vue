<template>
  <div>
    ...
    <el-form-item label="文件类型"
                  v-if="!data.oss&&data.isImg==false">
    ...
    <el-form-item label="是否预览">
      <el-switch v-model="data.listType" inactive-value="picture" active-value="text" ></el-switch>
    </el-form-item>
    ...
    <el-form-item label="多文件上传数量限制" v-if="data.multiple">
